...
try {
  var sock = new WebSocket('ws://192.168.1.21:800');
...
var heart = heartbeats__WEBPACK_IMPORTED_MODULE_4___default.a.createHeart('5');
/**
...
function handleMessage(messageEvent) {
  ...
  if (!initialized) {
    current = new timecode_boss__WEBPACK_IMPORTED_MODULE_3___default.a(messageObject.currentMS, messageObject.currentFPS);
  }

  current = timecode_boss__WEBPACK_IMPORTED_MODULE_3___default()(messageObject.currentMS, messageObject.currentFPS);
